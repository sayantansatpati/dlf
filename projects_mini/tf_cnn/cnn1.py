...
and [1, 2, 2, 1] for the strides. TensorFlow uses a stride for each input dimension,
...
to a dimension of the input tensor ([batch, height, width, channels]).
For both ksize and strides, the batch and channel dimensions are typically set to 1.

This is done to decrease the size of the output and prevent overfitting
'''
